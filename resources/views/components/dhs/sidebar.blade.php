  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
        ...
        <li class="nav-item">
          <a href="{{route('pelanggan.aqt')}}"
            class="nav-link {{ request()->routeIs('pelanggan.aqt') ? 'active' : '' }}">
            <i class="nav-icon fas fa-user-plus"></i>
            <p>
              Data Pelanggan
            </p>
        ...
        <li class="nav-item {{ request()->routeIs('bil_pelanggan') ? 'menu-open' : '' }}">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{route('bil_pelanggan')}}"
                class="nav-link {{ request()->routeIs('bil_pelanggan') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>Pelanggan</p>
              </a>
            </li>
        ...
        <li class="nav-item {{ request()->routeIs('member.pppoe') ? 'menu-open' : '' }}">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{route('member.pppoe')}}"
                class="nav-link {{ request()->routeIs('member.pppoe') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>PPPoE Profile</p>
              </a>
            </li>
        ...
        <li class="nav-item {{ request()->routeIs('member.router') ? 'menu-open' : '' }}">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{route('member.router')}}"
                class="nav-link {{ request()->routeIs('member.router') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>Router MikroTik</p>
              </a>
            </li>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            @if(auth()->user()->role == 'member')
            <li class="nav-item">
              <a href="{{route('profil.usaha')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Setting Profil Usaha</p>
              </a>
            </li>
            @endif
